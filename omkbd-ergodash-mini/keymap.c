...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QWERTY] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_LGUI, KC_LSFT, KC_SPC,    MO_RAIS, MO_LOWR, MO_MOUS,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [L_QWEMAC] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_LALT, KC_LSFT, KC_SPC,    MO_RAIS, MO_LOWR, MO_MMAC,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [L_LOWER] = LAYOUT(
    ...
    _______, KC_TILD, KC_GRV,  KC_DQUO, KC_QUOT, KC_BSLS, _______,                      _______, KC_PLUS, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______,
    _______, _______, _______, _______,          _______, _______, _______,    MO_AJST, _______, _______,          _______, _______, _______, _______
  ),
  ...
  */
  ...
  [L_MOUSE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          OS_GUI,  OS_SFT,  OS_CLR,     XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [L_MOUSE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          OS_ALT,  OS_SFT,  OS_CLR,     XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
